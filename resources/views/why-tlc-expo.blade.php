...
<main class="float-start w-100">
    <section class="why-divuy d-inline-block w-100">
       <div class="container">
          <div class="row">
            @foreach($datas as $data)
              <div class="col-12 col-md-6 col-lg-4">
                 <div class="info-divu-why d-inline-block w-100 s-bg" style="background-image: url(./images/{{ $data->background }});">
                    <div class="d-sm-flex d-lg-block d-xl-flex align-items-center inuy">
                        <div class="cion">
                           <img alt="su" src="images/{{ $data->icon }}">
                        </div>
                        <h5 class="itols"> {{ $data->title }} </h5>
                    </div>
