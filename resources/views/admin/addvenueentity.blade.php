          ...
          <div class="content-wrapper">
            <div class="row">
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title cmonu-head">Venues</h4>
                        <p> Tradeshow Venue </p>
                        <form name="addfrm" action="{{ URL::to('inserttradevenue') }}" method="POST" class="forms-sample">
                            @csrf
                            <div class="row">
                                <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <select name="entity_id" class="form-select">
                                      ...
                                      @php
                                          ...
                                          {
                                      @endphp
                                      <option value="{{ $val->id }}">{{ $val->legeal_name }}</option>
                                      @php
                                          }
                                      @endphp
                                    </select>
                                       ...
                                       <div class="row">
                                          ...
                                          <div class="col-lg-4">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <textarea name="driver_instruction[]" class="form-control texr08"></textarea>
                                             </div>
                                          </div>
                                       </div>
                                   </div>
