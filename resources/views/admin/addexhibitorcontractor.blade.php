   ...
   <x-adminsidebar/>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="row">
                <form name="addfrm" action="{{ URL::to('insertexhibitorcontractor') }}" method="POST" class="forms-sample">
                 @csrf
                              ...
                              <div class="row input-form" id="primary-div">
                                 <div class="col-lg-12 mb-2">
                                  ...
                                  <div class="col-lg-2">
                                      ...
                                      <input type="text" name="first_name[]" class="form-control txt"/>
                                  </div>
                                  </div>
                                  ...
                                  <div class="col-lg-2">
                                      ...
                                      <input type="text" name="last_name[]" class="form-control txt"/>
                                  </div>
                                  </div>
                                  ...
                                  <div class="col-lg-2">
                                      <div class="form-group">
                                      <label>Title</label>
                                      <input type="text" name="title[]" class="form-control txt"/>
                                     </div>
                                 </div>
                                 ...
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                    <label>Phone</label>
                                    <input type="text" name="exhibit_phone[]" class="form-control txt"/>
                                   </div>
                               </div>
                               ...
                               <div class="col-lg-3">
                                    <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" name="exhibit_email[]" class="form-control txt"/>
                                </div>
                              </div>
